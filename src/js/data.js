const empleos = [
    ...
    },
    {
        ...
        experiencia: "Mid",
        descripcion: "Spotify busca un Analista de Datos para diseñar y mantener APIs de alto rendimiento. Trabajarás con microservicios, bases de datos distribuidas y sistemas de mensajería a gran escala. Necesitamos a alguien con enfoque en escalabilidad y resiliencia.",
        responsabilidades: [
        ...
        requisitos: [
            "Experiencia con Excel y Google Sheets.",
            ...
            "Inglés básico-intermedio (lectura técnica)."
        ],
        sobreLaEmpresa: "Spotify es una empresa que busca mejorar la vida de las personas a través de productos innovadores. Ofrecemos un entorno inclusivo, flexible y con beneficios competitivos."
    },
    {
        id: 3,
    ...
    },
    {
        ...
        tipoContrato: "Por proyecto",
        experiencia: "Junior",
        descripcion: "Meta busca un Ingeniero DevOps para automatizar y mantener la infraestructura de la empresa. Trabajarás con equipos de producto e ingeniería para mejorar la experiencia de millones de usuarios.",
        responsabilidades: [
            "Automatizar y mantener la infraestructura de la empresa.",
            "Automatizar procesos de deployment y monitoreo.",
            "Diseñar y ejecutar scripts para automatizar tareas repetitivas.",
            "Gestionar y optimizar los servicios cloud.",
            "Implementar soluciones de seguridad y cumplimiento normativo."
        ],
        requisitos: [
            "Conocimiento en Python y Bash.",
            "Conocimiento en AWS y Google Cloud.",
            "Familiaridad con herramientas de automatización (Ansible, Terraform, Kubernetes).",
    ...
    },
    {
        ...
        tipoContrato: "Tiempo completo",
        experiencia: "Senior",
        descripcion: "Apple busca un Desarrollador Mobile especializado en iOS para desarrollar aplicaciones innovadoras para iPhone y iPad. Serás parte de un equipo de diseño y desarrollo, enfocado en crear experiencias fluidas, seguras y de alta calidad.",
        responsabilidades: [
...
const seleccionado = empleos.slice(0, 3);
